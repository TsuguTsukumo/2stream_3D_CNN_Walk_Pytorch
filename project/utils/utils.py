...
def random_split_video(
    fileDir: str,
    tarDir: str,
    rate: float = 0.8,
    version_flag: list = ("train", "val"),
    disease_flag: list = ("ASD", "LCS"),
):
    """
        ...
        for flag in version_flag:
            ...
            if os.path.exists(os.path.join(tarDir, flag, disease_flag)):
                ...
                if flag == "train":
                    ...
                    for name in sample:
                        shutil.copy(
                            os.path.join(fileDir_flag, name),
                            os.path.join(tarDir, flag, disease_flag),
                        )
